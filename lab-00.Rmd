...
```{r setup-tibble}
team_data <- tibble(
  name = c("Una", "Charlie", "Marta", 
           "member 3", "member 4"),
  github_username = c("unataylor06", "CharlieJK1", "marthahaksworth", 
                      "ferriswhynot", "s2501383"), 
  colour = c("pink", "green", "yellow", 
             "black", "blue"),
  hobby = c("reading", "squash", "climbing", 
            "", "travelling"),
  favourite_number = c(8, 5, 7, 4, 3)
  )
